...
var a=document.getElementsByClassName(".randomPizzaContainer"),r=pizzaContainers.length,n=function(e,a){var r=e.offsetWidth,n=document.getElementsByClassName("#randomPizzas").offsetWidth,i=r/n
return(function(e){switch(e){case"1":return.25
case"2":return.3333
case"3":return.5
default:console.log("bug in sizeSwitcher")}}(a)-i)*n}(pizzaContainers[0],e),i=pizzaContainers[0].offsetWidth+n+"px"
...
a.className="mover",a.src="images/pizza.png",a.style.height="100px",a.style.width="73.333px",a.basicLeft=e%8*256,a.style.top=256*Math.floor(e/8)+"px",document.getElementById("#movingPizzas1").appendChild(a)}updatePositions()})
